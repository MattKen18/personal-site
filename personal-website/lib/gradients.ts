...
export const gradients: Gradient = {
  'dark': {
    ...
    "base": "",
    "logo": "bg-clip-text text-transparent bg-gradient-to-r from-pink-400 via-green-600 to-blue-800",
  ...
  'light': {
    ...
    "base": "",
    "logo": "bg-clip-text text-transparent bg-gradient-to-r from-gray-800 via-green-600 to-blue-800",
